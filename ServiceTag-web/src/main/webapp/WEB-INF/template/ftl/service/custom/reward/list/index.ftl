...
<@inc.header '悬赏招募'>
    <script type="text/javascript">
        var singleUrl = '${urlServiceCustomRewardSingle}';
        var reviewUrl = '${urlServiceCustomRewardReview}';
        var finishUrl = '${urlServiceCustomRewardFinish}';
    </script>
</@inc.header>
    ...
    <div class="content content-col">
        <div class="content-in">
            ...
            <div class="main" id="J_Main">
                ...
                <div class="top-box">
                    <form id="J_Form">
                        <div class="tit fl">悬赏招募</div>
                        <a href="${urlServiceCustomRewardSingle}" class="comm-btn comm-btn-ex2 btn-new fr">创建悬赏</a>
...
<@inc.footer>
    <script type="text/javascript">
        seajs.use('${jsRoot}/app/service/custom/reward/list/main.js');
    </script>
</@inc.footer>