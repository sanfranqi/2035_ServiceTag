...
<@inc.header '日程管理'>
    <script type="text/javascript">
        var singleUrl = '${urlServiceCustomTimeSingle}';
    </script>
</@inc.header>

<@inc.body 'page-open page-manage-schedule'>

    <div class="content content-col">
        <div class="content-in">

            <#-- 左侧导航 开始 -->
            <@sidebar.nav 'time'></@sidebar.nav>
            <#-- 左侧导航 结束 -->
            ...
            <div class="main" id="J_Main">
                ...
                <div class="top-box">
                    <form id="J_Form">
                        ...
                        <input type="hidden" name="serviceType" value="101" />
                        <div class="tit fl">日程管理</div>
                        <a href="${urlServiceCustomTimeSingle}" class="comm-btn comm-btn-ex2 btn-new fr">创建日程</a>
...
<@inc.footer>
    <script type="text/javascript">
        seajs.use('${jsRoot}/app/service/custom/time/list/main.js');
    </script>
</@inc.footer>