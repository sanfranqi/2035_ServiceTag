...
<@inc.header '图文管理'>
    <script type="text/javascript">
        var singleUrl = '${urlServiceCustomArticleSingle}';
    </script>
</@inc.header>
    ...
    <div class="content content-col">
        <div class="content-in">
            ...
            <div class="main" id="J_Main">
                ...
                <div class="top-box">
                    <form id="J_Form">
                        <div class="tit fl">图文管理</div>
                        <a href="javascript:;" class="comm-btn comm-btn-ex2 fr" id="J_Add">创建超链接</a>
                        <a href="${urlServiceCustomArticleSingle}" class="comm-btn comm-btn-ex2 btn-new fr">创建图文</a>
...
<@inc.footer>
    <script type="text/javascript">
        seajs.use('${jsRoot}/app/service/custom/article/list/main.js');
    </script>
</@inc.footer>