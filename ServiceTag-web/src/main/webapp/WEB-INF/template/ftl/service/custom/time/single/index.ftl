...
<@inc.header '日程管理'>
    <script type="text/javascript">
        var listUrl = '${urlServiceCustomTime}';
    </script>
</@inc.header>
        ...
        <div class="content-in">
            ...
            <div class="main">
                ...
                <div class="service-box service-box-ex3">
                    ...
                    <a href="${urlServiceCustomTime}" class="comm-btn btn-l btn-service fr">返回</a>
                </div>
...
<@inc.footer>
    <script type="text/javascript">
        seajs.use('${jsRoot}/app/service/custom/time/single/main.js');
    </script>
</@inc.footer>