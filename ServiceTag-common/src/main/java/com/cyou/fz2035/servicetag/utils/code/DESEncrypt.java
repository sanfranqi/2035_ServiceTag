...
public class DESEncrypt implements IEncrypt {
    ...
    public DESEncrypt() throws NoSuchAlgorithmException, NoSuchPaddingException{
    ...
    public String encrypt(String str) {
        try {
            return new String(this.encrytor(str));
    ...
    public String decrypt(String enStr) throws DecryptException {
        try {
            return new String(this.decryptor(enStr.getBytes()));
        } catch (InvalidKeyException e) {
            e.printStackTrace();
        } catch (IllegalBlockSizeException e) {
            e.printStackTrace();
